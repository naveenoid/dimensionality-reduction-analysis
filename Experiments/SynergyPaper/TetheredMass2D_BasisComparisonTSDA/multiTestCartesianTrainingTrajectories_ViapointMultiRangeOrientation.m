...
for tspanMax = tspanRange
    ...
    for target = targetRange 
        ...
        for orientation = orientationRange
            ...
            xStart = [0;0]; 
            xD = [0.5;0.5];
            xMid = xD-target*[sin(orientation);cos(orientation)];%[0.5;0.5];
            numPoints  = 1;
         ...
         %   [score1, redOrder , redSys, hsvs, normHsvs ] = evaluateDimCost_BT(ones(mechOpt.inputDim),mechOpt,tempOpt,redThreshold,[],[],[],1);
            ...
            for j = 1:numBasis
                for i = 1:numTestTraj
                    ...
                    trainingFunc = generateBenchmarkTrajectoriesCartesian_viaPoint(xStart,xMindxD, tspan,mechOpt,cols(i,:));
