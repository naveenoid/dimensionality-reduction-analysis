function [ output ] = setupKC2lPassiveCompliant_LegendreBasisMDC( input_args )
%SETUPPASSIVECOMPLIANTCHAINBASISINPUT Summary of this function goes here
%   Detailed explanation goes here

    files{1} = './Data/SynergyPaper/KC2lPassiveCompliant_LegendreBasisMDC/';
    files{2} = './Experiments/SynergyPaper/KC2lPassiveCompliant_LegendreBasisMDC/';
